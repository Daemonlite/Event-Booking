    ...
    <div className="landing">
      <div class="header">
        <div class="head-text">
          ...
          <p class="para">
            You follow your passions, We'll take care of bookings. The Event
            Booking System that makes things easy.
          </p>

          <div class="btns">
            <div class="first-btn">
              <a href="/register" className="start">
                Start your search &#8594;
              </a>
            </div>
          </div>
      ...
      <section>
        ...
        <div className="section">
          <div class="card" style={{ width: "25rem" }}>
            <img
              src="https://cdn.bookwhen.com/assets/home/others/EventTrustConference-c068e05b1f2ca74abc9d82ce749ff47b6783c8a65c450465dcde7847150704b7.jpg"
              class="card-img-top"
              alt="..."
            />
            <div class="card-body">
          ...
          <div class="card" style={{ width: "25rem" }}>
            <img
              src="https://cdn.bookwhen.com/assets/home/others/EventTrustSeminar-6da747e377c716a694791e4a1f5cc4934d638a0b1cba9bf50430d896ad35389c.jpg"
              class="card-img-top"
              alt="..."
            />
            <div class="card-body">
          ...
          <div class="card" style={{ width: "25rem" }}>
            <img
              src="https://cdn.bookwhen.com/assets/home/others/EventTrustWorkshop-d7dfae0b2e3ce50d9aa5fc1f0da8f8646d5af7201fce761e84a6cc2342e1f976.jpg"
              class="card-img-top"
              alt="..."
            />
            <div class="card-body">
        ...
        <div className="section">
          <div class="card" style={{ width: "25rem" }}>
            <img
              src="https://cdn.bookwhen.com/assets/home/others/EventTrustEvent-597354ce5314d7896e74c15c351d0f5e6e2d7422be6dc5a2749c0a902636511c.jpg"
              class="card-img-top"
              alt="..."
            />
            <div class="card-body">
          ...
          <div class="card" style={{ width: "25rem" }}>
            <img
              src="https://cdn.bookwhen.com/assets/home/others/EventTrustFestival-b51b2d641b19c3741efd2c958032e04724cf3a22e87d6bfcdf08b68cd8551275.jpg"
              class="card-img-top"
              alt="..."
            />
            <div class="card-body">
          ...
          <div class="card" style={{ width: "25rem" }}>
            <img
              src="https://cdn.bookwhen.com/assets/home/others/EventTrustTheatre-3af2978e08b55c9cc8fcc9953e444e2bc56fab2b916c32196c732555141f9c0a.jpg"
              class="card-img-top"
              alt="..."
            />
            <div class="card-body">
        ...
        <div className="article">
          ...
          <div className="infos">
            ...
            <div className="cont">
              ...
              <p className="lime">
                Attach waivers and other documents to your booking form. Add
                marketing, GDPR, T&C's and photo consent fields.
              </p>
            </div>
          </div>
          <div className="infos">
        ...
        <div className="article">
          <div className="infos">
            ...
            <div className="cont">
              ...
              <p className="lime">
                Single, group, course, termly, family, child and early-bird
                tickets options. Set ticket allowances and cut-off times.
              </p>
            </div>
          </div>
          <div className="infos">
          ...
          <div className="infos">
            ...
            <div className="cont">
              ...
              <p className="lime">
                Check in attendees on the day with our register. Have all the
